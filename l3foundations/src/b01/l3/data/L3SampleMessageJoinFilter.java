 ...
 * @author 01Barmaja
 */
public class L3SampleMessageJoinFilter extends FocListFilter{
  ...
  public L3SampleMessageJoinFilter(FocConstructor constr) {
    super(constr);
  		...
  		for(int i=0; i<list.size(); i++){
  	        ...
  	        while(enumer != null && enumer.hasNext()){
  	          ...
  	          tarProp.copy(srcProp);
  				...
  				String testLabel = getPropertyString(L3SampleTestJoinDesc.FLD_TEST_FIELDS_START + L3TestDesc.FLD_LABEL);
  ...
  public static FocDesc getFocDesc() {
    if (focDesc == null) {
      focDesc = new FocDesc(L3SampleMessageJoinFilter.class, FocDesc.NOT_DB_RESIDENT, "SAMPLE_FILTER", true);
  ...
  public FilterDesc getThisFilterDesc(){
    return L3SampleMessageJoinFilter.getFilterDesc();
  }
}
