...
public class HSGDevDriver_UmizenP8000 extends L3TestCase implements HSGUnitGlobals {

	protected DriverSerialPort driver = null;

	public HSGDevDriver_UmizenP8000(FocTestSuite testSuite, String functionName) {
	...
	public void test_DRIVER_Pentra120() {
		try {
...
*/
			Instrument instr = PoolKernel.getInstrumentForAnyPool("PENTRA-ML");
			instr.switchOn();
