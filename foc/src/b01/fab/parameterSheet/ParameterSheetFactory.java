...
import b01.foc.ClassFocDescDeclaration;
...
public class ParameterSheetFactory {
  ...
  /*Not in use*/public static ParameterSheet getParameterSet(int id){/*Not in use*/
    ...
    HashMap<Integer, ParameterSheet> paramSetList = getHashMap();
    if(paramSetList != null){
      paramSet = paramSetList.get(paramSet.getId());
    }
    return paramSet;
  }
  ...
  public static void setEmptyParamSetAsDefaultParamSet(){
  	ParameterSheet emptyParameterSet = new ParameterSheet(ParameterSheetFactory.EMPTY_PARAM_SET_ID, ParameterSheetFactory.EMPTY_PARAM_SET_TITLE, new ClassFocDescDeclaration(Empty.class));
