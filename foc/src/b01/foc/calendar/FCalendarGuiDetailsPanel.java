...
public class FCalendarGuiDetailsPanel extends FPanel {
  ...
  public FCalendarGuiDetailsPanel(FocObject c, int view){
  	...
  	workTimesPanel.addField(calendar, FCalendarDesc.FLD_START_TIME, 0, 0);
  	workTimesPanel.addField(calendar, FCalendarDesc.FLD_END_TIME, 0, 1);
  	...
  	add(calendar, FCalendarDesc.FLD_STARTING_DAY_OF_WEEK, 2, 0);
  	add(workingDaysPanel, 2, 1, 2, 1, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE);  	  	
  	add(holidaysListPanel, 0, 1, 2, 2, GridBagConstraints.CENTER, GridBagConstraints.VERTICAL); 
