...
public class CashOpenClose extends FocObject {
  ...
  public static FPanel newBrowsePanel(FocList list, int viewID) {
    ...
    if (desc != null) {
      ...
      if (list != null) {
        ...
        //selectionPanel.getTable().setTableMinMax(50, 300, 1500, 300);
  ...
  public static FocDesc getFocDesc() {
    if (focDesc == null) {
      ...
      focObjFld = new FObjectField("CURRENCY", "Currency", FLD_CURRENCY, true, b01.foc.currency.Currency.getFocDesc(), "CURR_");
