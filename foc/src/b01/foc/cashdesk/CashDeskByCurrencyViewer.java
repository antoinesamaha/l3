...
public class CashDeskByCurrencyViewer extends FocObject {
  ...
  public CashDeskByCurrencyViewer(FocConstructor constr) {
    ...
    FObject opening = new FObject(this, FLD_CASH_OPENING, null) ;
    FObject closeing = new FObject(this, FLD_CASH_CLOSING, null) ;
    FDouble prevClosing = new FDouble(this, FLD_CASH_PREV_CLOSING, 0) ;
    FDate prevClosingDate = new FDate(this, FLD_CASH_PREV_CLOSING_DATE, new java.sql.Date(0)) ;
    FDouble movementTotal = new FDouble(this, FLD_CASH_MOVEMENT_TOTAL, 0) ;
    FDouble computedClosing = new FDouble(this, FLD_CASH_COMPUTED_CLOSING, 0) ;
    ...
    FList cashMovementListProp = new FList(this, FLD_CASH_MOVEMENT_LIST, cashMovementList) ;
